...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <div class="navbar-header">
    ...
    <a class="navbar-brand" >采风内容管理平台</a>
  </div>
  <!-- Top Menu Items -->
  <ul class="nav navbar-right top-nav">
    
    <li class="dropdown">
      <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> 采风 <b class="caret"></b></a>
              ...
              <div class="col-sm-5">
                <select class="form-control" name="title_font_color">
                  <option value="">==请选择颜色==</option>
                    ...
                    <?php if(is_array($titleColor)): foreach($titleColor as $key=>$color): ?><option value="<?php echo ($key); ?>" <?php if($key == $news['title_font_color']): ?>selected="selected"<?php endif; ?>><?php echo ($color); ?></option><?php endforeach; endif; ?>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="catid">
					...
					<?php if(is_array($barMenus)): foreach($barMenus as $key=>$barMenu): ?><option value="<?php echo ($barMenu["menu_id"]); ?>" <?php if($barMenu['menu_id'] == $news['catid']): ?>selected="selected"<?php endif; ?>><?php echo ($barMenu["name"]); ?></option><?php endforeach; endif; ?>
